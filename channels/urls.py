...
urlpatterns = [
    ...
    path('<int:pk>/digest/', views.channel_digest_edit, name='digest_edit'),
    path('<int:pk>/interesting-facts/', views.channel_interesting_facts_edit, name='interesting_facts_edit'),
